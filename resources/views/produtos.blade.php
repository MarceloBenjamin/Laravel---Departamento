            ...
            <div class="modal-content">
                <form class="form-horizontal" id="formProduto">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="QuantidadeProduto" class="control-label">Quantidade de Produto</label>
                            <div
                                class="input-group">
                                <input type="number" class="form-control" id="quantidadeProduto" placeholder="Quantidade de produto">
                            </div>
                        </div>
